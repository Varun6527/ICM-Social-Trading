...
// src/app/shared/resolvers/user.data.resolver.ts
var UserDataResolver = class _UserDataResolver {
  _authService;
  ...
  resolve() {
    return this._authService.getUserConfiguration().pipe(
      tap((data) => this._authService.userConfig = data)
      // Store data in service variable should be stored in ngrx
    );
  }
  static \u0275fac = function UserDataResolver_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _UserDataResolver)(\u0275\u0275inject(AuthService));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _UserDataResolver, factory: _UserDataResolver.\u0275fac, providedIn: "root" });
};

// src/app/shared/resolvers/user.profile.data.resolver.ts
var UserProfileDataResolver = class _UserProfileDataResolver {
  _webService;
  ...
  static \u0275fac = function UserProfileDataResolver_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _UserProfileDataResolver)(\u0275\u0275inject(WebService));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _UserProfileDataResolver, factory: _UserProfileDataResolver.\u0275fac, providedIn: "root" });
};
...
var routes = [
    ...
    children: [
      {
        path: "",
        pathMatch: "full",
        loadComponent: () => import("./chunk-AR3ZWIBN.js").then((s) => s.LoginStandAloneComponent),
    ...
    children: [
      {
        path: "",
        pathMatch: "full",
        loadComponent: () => import("./chunk-BDJMJOBD.js").then((s) => s.RegisterProviderStandAloneComponent),
        resolve: { myData: UserDataResolver }
      }
    ]
  },
  {
    path: "portal",
    loadChildren: () => import("./chunk-ARIPVQUI.js").then((m) => m.WebModule),
...
// src/app/web/interceptor/web.auth.interceptor.ts
var WebAuthInterceptor = class _WebAuthInterceptor {
  _authService;
  constructor(_authService) {
    this._authService = _authService;
  }
  ...
  static \u0275fac = function WebAuthInterceptor_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _WebAuthInterceptor)(\u0275\u0275inject(AuthService));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _WebAuthInterceptor, factory: _WebAuthInterceptor.\u0275fac });
};
...
var AppModule = class _AppModule {
  ...
  static \u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
    provideHttpClient(withInterceptorsFromDi()),
    {
      ...
      multi: true
      // Allows adding multiple interceptors
    }
  ], imports: [
    BrowserModule,
