...
// src/app/shared/component/showerror/show.error.standalone.component.ts
var ShowErrorStandAloneComponent = class _ShowErrorStandAloneComponent {
  snackBar;
  config;
  ...
  static \u0275fac = function ShowErrorStandAloneComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ShowErrorStandAloneComponent)(\u0275\u0275directiveInject(MatSnackBar));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ShowErrorStandAloneComponent, selectors: [["show-error-message"]], inputs: { config: "config" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 0, vars: 0, template: function ShowErrorStandAloneComponent_Template(rf, ctx) {
  }, dependencies: [MatSnackBarModule], styles: ["\n\n  .mat-mdc-snack-bar-container.default-error-style {\n  --mat-snack-bar-button-color: var(--primaryWhite);\n  --mdc-snackbar-container-color: var(--error-message--container-color);\n  --mdc-snackbar-supporting-text-color: var(--primaryWhite);\n  width: 350px;\n}\n  .mat-mdc-snack-bar-container.default-success-style {\n  --mat-snack-bar-button-color: var(--primaryWhite);\n  --mdc-snackbar-container-color: var(--primary-positive-color);\n  --mdc-snackbar-supporting-text-color: var(--primaryWhite);\n  width: 350px;\n}\n/*# sourceMappingURL=show.error.standalone.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ShowErrorStandAloneComponent, { className: "ShowErrorStandAloneComponent", filePath: "src\\app\\shared\\component\\showerror\\show.error.standalone.component.ts", lineNumber: 33 });
})();
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZFOVCG2I.js.map
